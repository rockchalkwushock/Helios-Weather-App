import {unitConverter} from '../src/conversions/conversions_2.0';
import {sunrise, sunset} from '../src/containers/CurrentWeather';
...
let time = newBackground.chooseIdentifier(hour, sunup, sundown);
